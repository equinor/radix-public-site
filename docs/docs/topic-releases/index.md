...
- Add block cache support, and used as default [options](/guides/volume-mounts/index.md#block-cache), for [blobFuse2](/radix-config/index.md#blobfuse2). See [guide](/guides/volume-mounts/) for details.
