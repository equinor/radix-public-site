...
- **Support channels:** File issue on [**radix** repo](https://github.com/equinor/radix-internal/issues) or ask on [#radix-support](https://equinor.slack.com/messages/CBKM6N2JY) on Slack
