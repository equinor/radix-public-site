...
- A 📖 [`radixconfig.yaml`](/radix-config/index.md) file that defines the running environments. By default, it is in the root directory of our repository.
...
The full syntax of `radixconfig.yaml` is explained in 📖 [`radixconfig.yaml`](/radix-config/index.md) reference.
...
In [`radixconfig.yaml`](/radix-config/index.md#components) we can define the following components:
