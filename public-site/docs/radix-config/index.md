...
- `proxyRequestBuffering`: Enable or disable proxying of the request body before sending it to your backend. Enabled by default. Disable this to get faster responses from your server when uploading, or streaming data to your API.
