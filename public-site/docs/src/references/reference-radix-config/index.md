...
- `useAzureIdentity` - If set to `true`, Radix will use [Azure Managed Identity Federated Credentials](../../guides/azure-key-vaults/#authorization-with-azure-managed-identity-federated-credentials) to access Azure Key Vault, an option [identity.azure.clientId](../../guides/workload-identity/#configure-workload-identity-in-radix) have to be defined. This field is optional, default value: `false`, using [Azure Service Principal Client ID and Client Secret](../../guides/azure-key-vaults/#authorization-with-azure-service-principal-client-id-and-client-secret).
