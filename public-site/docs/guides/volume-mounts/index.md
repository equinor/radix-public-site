...
- Define the volume mounts for the environment in the [radixconfig.yaml](/docs/radix-config). The container should match the one found in step 1
...
- Define the volume mounts for the environment in the [radixconfig.yaml](/docs/radix-config).
