...
**Workload identity** for a component or job is configured in the [identity](/docs/radix-config/index.md#identity) section in [radixconfig.yaml](/docs/radix-config/index.md).  
