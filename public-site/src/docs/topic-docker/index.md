...
> Be aware - [the syntax for add user and group](../../guides/docker-useradd/index.md) can be different for the distribution of images
...
The official Docker documentation has a set of [best practices](https://docs.docker.com/develop/develop-images/dockerfile_best-practices/index.md) when it comes to creating `Dockerfile`s. This is often related to optimizing build, push and pull speed and creating small and secure images.
