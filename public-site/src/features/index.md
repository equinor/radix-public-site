...
[Guide](../guides/build-secrets/index.md) -  [Radix config reference](../references/references/reference-radix-config/#secrets)
...
[Doc](../docs/topic-concepts/#external-custom-alias) [Guide](../guides/external-alias/index.md) - [Radix config reference](../references/reference-radix-config/#dnsexternalalias)
...
[Guide](../guides/monitoring/#monitoring-your-app) - [Doc](../docs/topic-monitoring/index.md) - [Radix config reference](../references/reference-radix-config/#monitoring) and [config reference](../references/reference-radix-config/#monitoringconfig)
...
[Doc](../docs/topic-concepts/#sub-pipeline) [Guide](../guides/sub-pipeline/index.md) - [Tekton documentation](https://tekton.dev/docs/pipelines/pipelines/)
